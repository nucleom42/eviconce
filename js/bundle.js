...
`,document.head.appendChild(e)}})();var D=G(Y());var F=G(Y());(function(){if(!document.getElementById("e0effbf012d52a248d477153a26577f119e83cb3bd3a3bea5ba5a3bb920b7280")){var e=document.createElement("style");e.id="e0effbf012d52a248d477153a26577f119e83cb3bd3a3bea5ba5a3bb920b7280",e.textContent=`/* Booking Scheduler Styles */
.booking-overlay {
  position: fixed;
  inset: 0;
...
`,document.head.appendChild(e)}})();function xu({employees:e,companyId:t}){let[n,r]=(0,Q.useState)(Qn(new Date)),[o,a]=(0,Q.useState)(null),[i,l]=(0,Q.useState)(null),[s,u]=(0,Q.useState)(null),[p,d]=(0,Q.useState)([]),[m,w]=(0,Q.useState)([]),v=(0,Q.useRef)(null),[g,x]=(0,Q.useState)(null),[f,c]=(0,Q.useState)(null),[h,b]=(0,Q.useState)(null),[y,C]=(0,Q.useState)(!1),[k,N]=(0,Q.useState)(null),A=Array.from({length:7},(T,q)=>kn(n,q)),E=new Date,J=()=>{let T=n.toISOString().slice(0,10),q=kn(n,6).toISOString().slice(0,10);fetch(`/api/employees/${i.id}/availability?from=${T}&to=${q}`).then(K=>K.json()).then(K=>{u(K.employee.window),d(K.employee.upcoming_windows),w(K.employee.time_slots)})};(0,Q.useEffect)(()=>{i&&J()},[i,n]);let[M,B]=(0,Q.useState)(new Date);(0,Q.useEffect)(()=>{let T=()=>B(new Date);T();let q=setInterval(T,300*1e3);return()=>clearInterval(q)},[]);let X=(0,Q.useRef)(null),[fe,Nn]=(0,Q.useState)(0);(0,Q.useEffect)(()=>{X.current&&Nn(X.current.getBoundingClientRect().height)},[n,i]);let Ft=M.toISOString().slice(0,10),Ct=M.getHours(),Mt=M.getMinutes(),_n=fe*Ct+fe*Mt/60,qn=["window-a","window-b","window-c","window-d","window-e"],Ir=T=>{let q=Io(T,[s,...p||[]]);if(!q)return"";let K=q.id%qn.length;return qn[K]},re=A.some(T=>T.toISOString().slice(0,10)===Ft);(0,Q.useEffect)(()=>{let T=v.current;T&&requestAnimationFrame(()=>{let q=T.scrollHeight-T.clientHeight;T.scrollTop=q/2})},[n,i]);let O=(T,q)=>Xe(Kn(new Date(T),q)),_=(T,q)=>{if(!g||g.day!==T.toISOString().slice(0,10))return!1;let K=Jn(T,q,0),It=Jn(T,q+1,0),Ar=Et(g.start_time),Xt=Et(g.end_time);return Ao(Ar,Xt,K,It)},z=(T,q,K)=>{let It=Et(T.start_time);return It?It.getHours()===K&&T.day===q.toISOString().slice(0,10):!1},V=(T,q)=>{let K=T.toISOString().slice(0,10),It=Jn(T,q,0),Ar=Jn(T,q+1,0);return m.filter(Xt=>{if(Xt.day!==K)return!1;let At=Et(Xt.start_time),Wo=Et(Xt.end_time);return Ao(At,Wo,It,Ar)})};return Q.default.createElement("section",{className:"calendar-card"},Q.default.createElement(vu,{days:A,weekStart:n,setWeekStart:r,employees:e,currentEmployee:i,setCurrentEmployee:T=>{T?l(T):(l(null),w([]),u(null),x(null),d([]))}}),Q.default.createElement("div",{className:"week-calendar"},Q.default.createElement("div",{className:"week-header"},Q.default.createElement("div",{className:"time-col"}),A.map(T=>{let q=T<E,K=Io(T,[s,...p||[]]);return Q.default.createElement("div",{key:T.toISOString(),className:`day-col-header
                          ${T.toDateString()===E.toDateString()?"today":""}
                          ${Ir(T)}
                        `,"data-tooltip":!i||!K?.effective_date?"":`Window
Starting ${K?.effective_date}
Ending ${K?.end_date||"\u221E"}`,onClick:()=>{q||(N(T),C(!0))}},i&&!q&&Q.default.createElement("span",{className:"edit-icon"},K?"\u2699\uFE0F":"\u2795"),Q.default.createElement("div",null,T.toLocaleDateString("uk-UA",{weekday:"short"})),Q.default.createElement("div",null,T.getDate()))}),i&&k&&Q.default.createElement(Bo,{open:y,employee:i,window:Io(k,[s,...p||[]]),onClose:()=>{N(null),C(!1)},onSaved:T=>{l(q=>q&&{...q,window:T})}})),Q.default.createElement("div",{className:"week-body",ref:v},re&&fe>0&&Q.default.createElement("div",{className:"now-line",style:{top:`${_n}px`}},Q.default.createElement("div",{className:"now-dot"})),rm.map((T,q)=>Q.default.createElement("div",{key:T,className:"week-row",ref:q===0?X:null},Q.default.createElement("div",{className:"time-col"},T,":00"),A.map(K=>{let It=V(K,T),Ar=K<Qn(new Date),Xt=om({day:K,hour:T,windows:[s,...p]});return Q.default.createElement("div",{key:`${K.toISOString()}-${T}`,className:`week-cell ${Xt?"":Ar?"past":"unavailable"}`,onMouseDown:At=>{if(b(null),!Xt||!i)return;let Wo=At.currentTarget.getBoundingClientRect(),Lu=(At.clientY-Wo.top)/Wo.height>=.5?30:0,cm=Lu+30,Si=Jn(K,T,Lu),Ei=Jn(K,T,cm);for(let Zt of It){let Ci=Et(Zt.start_time),dm=Et(Zt.end_time);if(Ao(Si,Ei,Ci,dm)){c(Zt),a(Zt);return}}if(g){let Zt=Et(g.start_time),Ci=Et(g.end_time);if(g.day===K.toISOString().slice(0,10)&&Ao(Si,Ei,Zt,Ci)){a(g);return}}x({day:K.toISOString().slice(0,10),dayIndex:A.findIndex(Zt=>Zt.toDateString()===K.toDateString()),start_time:Xe(Si),end_time:Xe(Ei),state:"preview",employee_id:i.id,company_id:t})}},It.filter(At=>z(At,K,T)).map(At=>Q.default.createElement(ki,{key:At.id,timeSlot:At})),g&&z(g,K,T)&&Q.default.createElement(ki,{timeSlot:g}))}))))),o&&Q.default.createElement(wu,{slot:o,weekStart:n,previewSlot:g,setPreviewSlot:x,setTimeSlots:w,setEditingSlot:a,editingSlot:o,currentEmployee:i}))}var te=G(Y());(function(){if(!document.getElementById("85680663e3af3af3040ba0baa2d9af434f71b3c84e52d8c7f14a6909fce9151c")){var e=document.createElement("style");e.id="85680663e3af3af3040ba0baa2d9af434f71b3c84e52d8c7f14a6909fce9151c",e.textContent=`.employees-container {
  padding: 24px;
  width: 100%;
}
...
.category-mini-remove:hover {
  background: rgba(255, 255, 255, 0.25);
}

.category-input-wrapper .search-input {
  padding: 0 12px 8px;
}
...
.category-dropdown-search::-webkit-scrollbar,
.search-results-dropdown::-webkit-scrollbar {
  width: 8px;
}

.category-dropdown-search::-webkit-scrollbar-track,
.search-results-dropdown::-webkit-scrollbar-track {
  background: #f3f4f6;
  border-radius: 10px;
}

.category-dropdown-search::-webkit-scrollbar-thumb,
.search-results-dropdown::-webkit-scrollbar-thumb {
  background: #d1d5db;
  border-radius: 10px;
}

.category-dropdown-search::-webkit-scrollbar-thumb:hover,
.search-results-dropdown::-webkit-scrollbar-thumb:hover {
  background: #9ca3af;
}
/* Add to Welcome.css - CompanyForm-style Categories */
