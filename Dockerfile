...
RUN apt-get update -qq && apt-get install -y build-essential libpq-dev curl git imagemagick
...
RUN apt-get update -qq && apt-get install -y libpq5 curl imagemagick && rm -rf /var/lib/apt/lists/*
WORKDIR /app
